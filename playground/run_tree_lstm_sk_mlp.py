...
from udao_spark.model.utils import (
    MyLearningParams,
    TreeLSTMSKParams,
    get_tree_lstm_sk_mlp,
    param_init,
    train_and_dump,
)
from udao_spark.utils.params import get_tree_lstm_params, wrap_sk_mlp_params

logger.setLevel("INFO")
if __name__ == "__main__":
    params = wrap_sk_mlp_params(get_tree_lstm_params()).parse_args()
    ...
    model_params = TreeLSTMSKParams.from_dict(
        {
    ...
    model = get_tree_lstm_sk_mlp(model_params)
