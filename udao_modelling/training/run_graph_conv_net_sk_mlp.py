...
import torch as th
import typer
from udao_modelling.params import GraphConvParams, get_parameters
...
def main(
    ...
    params = get_parameters(config, GraphConvParams)
    # params = wrap_sk_mlp_params(get_graph_conv_net_params()).parse_args()
    ...
    model_params = GraphConvNetSKMLPParams.from_dict(
        {
            "iterator_shape": split_iterators["train"].shape,
            "op_groups": params.op_groups,
            "output_size": params.output_size,
            "gcn_n_layers": params.gcn_n_layers,
    ...
    model = get_graph_gcn_sk_mlp(model_params)
