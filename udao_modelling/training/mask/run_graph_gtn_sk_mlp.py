...
from udao_modelling.mask.utils import get_graph_transformer_masked_sk_mlp
import udao_modelling.mask.models
...
def main(
    ...
    # TODO (glachaud): that's were I am in the code
    ...
    # set the mask probability for word2vec
    # TODO (glachaud): this should be put in the parameters.
    udao_modelling.mask.models.set_probability(0.5)
    model = get_graph_transformer_masked_sk_mlp(model_params)
