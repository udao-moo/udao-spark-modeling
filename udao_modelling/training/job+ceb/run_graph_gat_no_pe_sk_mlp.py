...
import torch as th
import typer
from udao_modelling.data._job_ceb import get_split_iterators
from udao_modelling.mask.utils import get_gat_masked_sk_mlp
...
def main(
    ...
    model_params = GraphTransformerSKMLPParams.from_dict(
        {
            ...
            "attention_layer_name": "GAT_NO_PE",
    ...
    model = get_gat_masked_sk_mlp(model_params)
